...
const RegisterForm = () => {
    ...
    const buttonSign = 'bg-gradient-to-r from-customPink to-customPurple text-white hover:from-pink-600 hover:to-purple-700 w-[139px] top-[986px] left-[5292px] rounded-[5px] py-[14px] px-[22px]'
    const inputStyle = 'w-[350px] top-[746px] outline-none py-[12px] px-[28px] bg-[#3D3D49] left-[5292px] rounded-[5px] my-[10px]'
  return (
    <div>
        <div className='w-[359px] top-[569px] left-[5292px] bg-black rounded-[1px]'>
            <form action="">
                ...
                <div className='grid grid-cols-2 mt-[35px] w-[350px] h-[51px] top-[1069px] left-[5292px]'>
                    <div className='w-[168px] flex justify-center py-[2px] left-[5292] rounded-[5px] bg-[#3D3D49]'>
