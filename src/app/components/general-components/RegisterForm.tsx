...
const RegisterForm = () => {
    const buttonStyle = 'px-4 bg-'
    const buttonSign = 'bg-gradient-to-r from-kpink to-kpurple text-white hover:from-pink-600 hover:to-purple-700 w-[139px] top-[986px] left-[5292px] rounded-[5px] py-[8px] px-[22px]'
    const inputStyle = 'w-[350px] top-[746px] outline-none py-[12px] px-[28px] bg-klightGrey left-[5292px] rounded-[5px] my-[10px]'
  return (
    <div>
            ...
            <form action="">
                <div>
                    <Titles 
                        ...
                        subtitleStyle='text-[18px] w-[358px] h-[66px] leading-[28px] top-[653px] left-[5293px] font-[400] color-[#9E9E9E]' 
                    />
                </div>
                ...
                <div className='grid grid-cols-2 mt-[35px] w-[350px] h-[51px] top-[1069px] left-[5292px]'>
                    <div className='w-[168px] flex justify-center py-[4px] left-[5292] rounded-[5px] bg-klightGrey'>
