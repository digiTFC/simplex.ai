...
export const Input:React.FC<inputProps> = ({placeholder,name,onChange,value, type,error}) => {
  ...
  return (
    <div className='flex flex-col relative'>
        <label className={`text-klight transition-all relative ${value != null ? value.length == 0?' top-5': `-top-0 pt-5 pb-2` : ''}`} htmlFor={placeholder}>{placeholder}</label>
