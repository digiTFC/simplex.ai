...
const ContentBox:React.FC<contentBoxProps> = ({isBlack, children, width, height}) => {
  ...
  return (
    <div>
        <div className={` ${width ?? `max-w-[90vh] w-[325px] `} relative overflow-hidden ${ height ?? `h-[380px]`} ${!isBlack ? `bg-gradient-tp-br from-kpink to-kpurple` : `bg-klightGrey` }    rounded-3xl`}>
