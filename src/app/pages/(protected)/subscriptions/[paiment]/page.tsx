...
const Paiement = () => {
  ...
  const style = "text-[30px] font-semibold";
  return (
    <div className="m-auto w-11/12 py-12 m-auto md:flex items-start justify-center flex-col h-full">
      <div
        className=" cursor-pointer flex items-center group text-black group rounded-lg transition-all bg-white px-8 py-2 w-fit"
        onClick={() => router.back()}
      >
<IoArrowBack size={20} className="size-6 group-hover:translate-x-[-5px] transition-all"/>
        ...
        <div className="md:w-5/12">
          ...
          <div className="hidden md:block">
            ...
            <p className="text-klight ">
              ...
              List as many projects as your creativity allows. Whether
              it&lsquo;`s sleek mobile apps, intuitive web interfaces, or
              immersive user experiences, there&lsquo;`s no limit to the number
              of masterpieces you can display, drawing clients into your world
              of design brilliance.
            </p>
          </div>
        </div>
