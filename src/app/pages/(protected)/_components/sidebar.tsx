...
const siderBarSettings = [
  ...
  },
  {
    ...
    label: "My Bots",
    route:"/pages/dashboard/chat-bots"
  },
  {
    icon: (
      <svg
  ...
  return (
    <div className=" w-full h-full">
      <div className="w-[300px] px-5 bg-klightGrey -100 h-[100vh] flex flex-col fixed">
        <div>
          <div className="flex items-center py-5    gap-4">
            ...
            <div className="flex flex-col bg-clip-text text-[24px] text-transparent bg-gradient-to-br from-kpurple to-kpink">
              <span className="font-semibold">SIMPLEXm</span>
        ...
        <div onClick={logout} className="mt-auto cursor-pointer text-white mb-10 gap-5 hover:bg-red-400 hover:bg-opacity-25 transiton-all rounded-xl py-3 px-3 flex">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
